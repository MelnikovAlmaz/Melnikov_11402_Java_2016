...
public class ComplexMatrix2x2 {
    ...
    public ComplexMatrix2x2() {
        ...
        this(ac.getBean(ComplexNumber.class), ac.getBean(ComplexNumber.class), ac.getBean(ComplexNumber.class), ac.getBean(ComplexNumber.class));
    }
